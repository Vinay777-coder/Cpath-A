          ...
          <div className="flex-1 max-w-4xl">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm text-gray-600">PathU Team</p>
              ...
              {/* Hero Image */}
              <div className="bg-gradient-to-r from-purple-900 via-blue-900 to-indigo-900 rounded-lg p-8 mb-6 relative overflow-hidden">
                <div className="relative z-10">
                  <h2 className="text-2xl font-bold text-white mb-2">JavaScript Coding</h2>
                  <h3 className="text-xl text-purple-300 mb-4">interview questions</h3>
